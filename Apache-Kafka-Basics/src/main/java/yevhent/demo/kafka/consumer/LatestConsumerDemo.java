...
public class LatestConsumerDemo {

    private static final Logger LOGGER = LoggerFactory.getLogger(LatestConsumerDemo.class.getName());

    /**
     * The same as default <b>--offset</b> (not specified offset) for CLI request to kafka-console-consumer.sh
     */
    ...
    public static void main(String[] args) {
        ...
        properties.setProperty(ConsumerConfig.GROUP_ID_CONFIG, "java-latest");
