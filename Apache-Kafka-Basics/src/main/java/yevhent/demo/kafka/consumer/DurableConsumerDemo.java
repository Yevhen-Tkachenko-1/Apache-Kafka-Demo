...
public class DurableConsumerDemo {

    private static final Logger LOGGER = LoggerFactory.getLogger(DurableConsumerDemo.class.getName());
    ...
    public static void main(String[] args) {
        ...
        properties.setProperty(ConsumerConfig.GROUP_ID_CONFIG, "java-durable");
