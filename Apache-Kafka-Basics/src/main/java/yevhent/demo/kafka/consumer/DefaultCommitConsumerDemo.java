...
public class DefaultCommitConsumerDemo {

    private static final Logger LOGGER = LoggerFactory.getLogger(DefaultCommitConsumerDemo.class.getName());
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        properties.setProperty(ConsumerConfig.GROUP_ID_CONFIG, "java-default-commit");
        ...
        // we don't use close, to see that some messages could be consumed but not committed
        //consumer.close();
    }
}